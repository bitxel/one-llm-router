...
func TestCodexBridgeBuildUpstreamRequestNormalizesResponses(t *testing.T) {
	...
	assert.Equal(t, "https://chatgpt.example.test/backend-api/codex/responses?trace=true&client_version="+CodexClientVersion, upstreamReq.URL)
...
func TestCodexCompactBridgeBuildUpstreamRequestNormalizesCompact(t *testing.T) {
	...
	assert.Equal(t, "https://chatgpt.example.test/backend-api/codex/responses/compact?client_version="+CodexClientVersion, upstreamReq.URL)
	assert.Equal(t, "identity", upstreamReq.Headers.Get("Accept-Encoding"))
...
func TestCodexModelsBridgeBuildUpstreamRequestUsesModelsFacadeAdapter(t *testing.T) {
	...
	assert.Equal(t, "https://chatgpt.example.test/backend-api/codex/models?client_version="+CodexClientVersion, upstreamReq.URL)
